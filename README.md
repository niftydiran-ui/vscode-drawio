...
-   Mustaq Sohail Shaik, [dirandodda](https://github.com/dirandodda) on Github (Current Maintainer)
-   Henning Dieterichs, [hediet](https://github.com/hediet) on Github (Original Author)
-   Vincent Rouill̩, [Speedy37](https://github.com/Speedy37) on Github
...
The original author, Henning Dieterichs, also developed these extensions:
